...
public class EclipseSourceLinks implements SourceLinks {
	...
	private static final String JAVA_TYPE_COMMAND = "org.springframework.tooling.boot.java.ls.OpenJavaType";
	private static final String FQ_NAME_PARAMETER_ID = "fqName";
	private static final String PROJECT_NAME_PARAMETER_ID = "projectName";

	private static final String RESOURCE_COMMAND = "org.springframework.tooling.boot.java.ls.OpenResourceInEditor";
	...
	public Optional<String> sourceLinkUrlForFQName(IJavaProject project, String fqName) {
		fqName = "org.springframework.boot.liquibase.LiquibaseServiceLocatorApplicationListener$LiquibasePresent";
		try {
